...
function Footer() {
  ...
  return (
    <footer className="mt-10 font-bold fixed inset-x-0 bottom-0 bg-white py-3 px-6 shadow-md flex flex-col sm:flex-row justify-between items-center text-center text-[#D4CAA3] space-y-2 sm:space-y-0">
